# 🏎️ WRC Group B: A Era de Ouro

Este projeto é um estudo focado na estruturação de conteúdo web, utilizando como tema a história do Grupo B de Rally.
...
- **O que será aplicado:**
  - Criação de um arquivo `style.css` externo.
  - Uso de Classes e IDs.
  - Definição de cores (Paleta Audi Sport).
  - Ajustes de fontes e espaçamentos (Padding/Margin).
